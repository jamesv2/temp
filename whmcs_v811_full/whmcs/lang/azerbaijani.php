...
$_LANG['store']['toggleNav'] = "Naviqasiyaya keçid";
...
$_LANG['support']['requestor']['externaluser'] = "Xarici istifadər";
...
$_LANG['store']['ox']['faq8']['answer'] = "OX App Suite bu dilləri dəstəkləyir: ingilis, alman, danimarka, çex, ispan, fransız, italyan, latış, macar, niderland, polyak, portuqal, rus, rumın, slavak, fin, isveç, 中文 简体 , 中文 繁體, 日本語 日本";
