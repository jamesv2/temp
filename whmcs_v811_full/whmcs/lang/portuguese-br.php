...
$_LANG['invoiceofflinepaid'] = "Pagamentos via cartão de crédito são processados manualmente offline. Você receberá uma confirmação por email quando seu pagamento for processado.";
$_LANG['invoicerefnum'] = "Nº de referência";
$_LANG['invoices'] = "Minhas Faturas";
$_LANG['invoicesamount'] = "Valor";
$_LANG['invoicesattn'] = "Att.";
$_LANG['invoicesbacktoclientarea'] = "<< Retornar para Área do Cliente";
...
$_LANG['upgradecurrentconfig'] = "<font color=white>Configuração Atual</font>";
...
$_LANG['hostingInfo'] = "<font color=white>Informações de Hospedagem</font>";
